...
## Planejamento — Fase 0 (Semana 1)

- [Documento de visão do produto (MVP)](./docs/planning/phase-0-visao-produto.md)
- [Arquitetura inicial (camadas e decisões)](./docs/planning/phase-0-arquitetura-inicial.md)
- [Backlog inicial priorizado (épicos e histórias)](./docs/planning/phase-0-backlog-priorizado.md)
